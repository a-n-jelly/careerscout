...
>
> **Note:** This file controls what gets fetched and how roles are scored. A separate file, `feed-agent/my_filters.json`, controls fast pre-filtering (wrong role types, excluded locations, company skip list, hard-no title patterns). Both are generated by `/feed-setup` and updated by `/calibrate`.
